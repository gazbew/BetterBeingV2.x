...
export const WellnessJourney = () => {
  return (
    <section id="wellness" className="py-20 bg-background text-center">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-primary mb-6">
            From Where You Are
            <span className="block text-primary">To Better Being</span>
          </h2>
        ...
        <div className="relative mb-20 animate-scale-in">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating Stats */}
              <div className="absolute -top-6 -right-6 bg-primary text-primary-foreground rounded-2xl p-4 shadow-premium animate-float">
            ...
            <div className="space-y-8">
              ...
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-premium mt-8"
              >
