...
export const ProductsSection = () => {
  ...
  return (
    <section id="products" className="py-24 bg-gradient-to-b from-white to-primary/5">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8 mb-16">
          {featuredProducts.slice(0, 8).map((product: Product, index: number) => (
            <Card
              key={product.id}
              className="relative group hover:shadow-wellness transition-all duration-500 hover:-translate-y-2 border border-border/20 bg-white overflow-hidden rounded-2xl"
            ...
            >
              ...
              <CardContent className="p-0">
                ...
                <div className="relative h-64 bg-gradient-to-br from-primary/5 via-white to-secondary/5 p-6 flex items-center justify-center group-hover:from-primary/10 group-hover:to-secondary/10 transition-all duration-500">
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  />
                  {/* Wellness Badge */}
                  <div className="absolute top-4 right-4 bg-white/95 rounded-2xl p-2.5 shadow-wellness">
